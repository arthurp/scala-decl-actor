...
class Message7[A1, A2, A3, A4, A5, A6, A7](owner : DeclActor) extends Message(owner) {
    ...
    def unapply(v:Any) : Option[(A1, A2, A3, A4, A5, A6, A7)] = v match {
        case ActorMessage(src, (a1:A1, a2:A2, a3:A3, a4:A4, a5:A5, a6:A6, a7:A7)) if src eq this => Some((a1, a2, a3, a4, a5, a6, a7))
        case _ => None
    }
}

class SyncMessage7[R, A1, A2, A3, A4, A5, A6, A7](implicit owner : DeclActor, rClass : Manifest[R]) extends Message7[A1, A2, A3, A4, A5, A6, A7](owner) with SyncMessage[R] {
