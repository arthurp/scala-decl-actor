...
class Message6[A1, A2, A3, A4, A5, A6](owner : DeclActor) extends Message(owner) {
    ...
    def unapply(v:Any) : Option[(A1, A2, A3, A4, A5, A6)] = v match {
        case ActorMessage(src, (a1, a2, a3, a4, a5, a6)) if src eq this => Some((a1.asInstanceOf[A1], a2.asInstanceOf[A2], a3.asInstanceOf[A3], a4.asInstanceOf[A4], a5.asInstanceOf[A5], a6.asInstanceOf[A6]))
        case _ => None
    }
}

class SyncMessage6[R, A1, A2, A3, A4, A5, A6](implicit owner : DeclActor, protected[this] val rClass : Manifest[R]) extends Message6[A1, A2, A3, A4, A5, A6](owner) with SyncMessage[R] {
